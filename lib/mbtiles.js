...
// node-0.10.x: prevent "Recursive process.nextTick detected." deprecation
// warnings
...
var DataGatherer = function() {
    ...
    this._transform = function(obj, encoding, done) {
        var self = this;
        var chunks = [];

        return obj.pipe(through2(function _transform(chunk, encoding, callback) {
            chunks.push(chunk);
