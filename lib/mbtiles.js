...
var ts = require('tilelive-streaming');
...
MBTiles.prototype.createReadStream = function(options) {
    var source = this,
    ...
    readable._read = function() {
        ...
        var headers = {
            'Content-Type': MBTiles.utils.getMimeType(row.data),
